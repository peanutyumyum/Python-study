# 포매팅(formatting)은 포맷코드를 사용하여(%d, %s, %f...) 문자열 안에서 특정 문자만을 바꾸거나 삽입하는 방법이다.
...
print(a)
# or
a = "I have %02d apples" % 3 # %02d를 사용하였다. %02d는 2자리 숫자를 포매팅하고, 남은 자리는 0으로 채우겠다는 것이다.(숫자d%에서 숫자는 자릿수를 뜻한다.)
print(a) # 그렇기 때문에 결과 값으로 "I have 03 apples" 가 출력된다.
...
# 소숫점을 표현하는 포매팅
a = 3.4242424242
b = "%10.4f" % a # %자료의 길이.표시하고 싶은 소숫점 자릿 수()f 의 형태를 지닌 것이다.
...
number = 3
fruit = "apple"
a = "I ate {0}apples and I like {1}!".format(number, fruit)
print(a)
# or
